...
Potentially remove variables with many NAs - e.g. 
- we remove all economic data
- decide if to take all possible variables or concentrate on larger summary vars (PCA??)
...
- decide whether the individual small vars are relevant or to use only global summary vars
