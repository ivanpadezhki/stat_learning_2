...
```{r}
# build plots
bar_junk <- ggplot(data = ds_pre, aes(x = JunkFood, fill = Diabetic)) +
...
grid.arrange(bar_urin, bar_bplev, bar_highbp, ncol = 3, top=textGrob("Bar plots of categorical Variables"))
```
...
# BMI and Smoking
boxplot(~Smoking, data = ds_fin, main = "BMI of Smoker and Non-Smoker subjects",ylab = "BMI",names = c("Non-Smoker", "Smoker"))
