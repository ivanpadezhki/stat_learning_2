...
ggplot(ds_pre, aes(x=Gender, y=Pregnancies, fill = Pdiabetes)) + 
  geom_boxplot() + 
  geom_jitter(alpha = 0.5, width = 0.2, height = 0.2, color = "tomato") + 
  labs(x = "Gender", y = "Pregnancies", title = "Number of Pregnancies by Gender")
```
...
```{r}
ggplot(ds_pre[ds_pre$Gender=='Female',], aes(x=Pdiabetes, y=Pregnancies, fill = Diabetic)) + 
