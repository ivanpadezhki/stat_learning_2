...
Additionally, the relationship between Sleep and Sound Sleep is evaluated
```{r}
...
Furthermore, the relationship of the numerical variables with the outcome variable is explored.
```{r}
